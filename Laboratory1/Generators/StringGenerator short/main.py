...
#Создали массив со строками нужной размерности (потом вставим его в файл)
count = 100000
strMas = [0] * count
optimas = [0] * count

#Начинаем изменять строки по одной
for i in trange(count):
    strMas[i] = rstr.xeger('nfs://[a-zA-Z]{1,15}/(?:([a-zA-Z._]{1,20}/([a-zA-Z._]{1,12})|([a-zA-Z._]{1,12})))') #норм
